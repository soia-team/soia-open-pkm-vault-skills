...
def resolve_repo_name(root: Path) -> str:
    ...
    # https://github.com/soia-team/soia-open-pkm-vault-skills.git  -> soia-open-pkm-vault-skills
    # git@github.com:soia-team/soia-open-pkm-vault-skills.git       -> soia-open-pkm-vault-skills
    tail = url.rstrip("/")
    for sep in ("/", ":"):
        if sep in tail:
