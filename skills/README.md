...
| [`soia-pkm-transform-article-ppt`](./soia-pkm-transform-article-ppt/) | 生成带内容追踪、双 Lens 审稿和宿主验收的可编辑 PPTX | Use $soia-pkm-transform-article-ppt to turn this article into a source-traced editable PPTX with separate content/design plans, dual-lens review, and host-render validation. |
