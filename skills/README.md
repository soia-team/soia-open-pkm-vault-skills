...
| [`soia-pkm-query-vault`](./soia-pkm-query-vault/) | 只读搜索 vault，并区分当前、稳定、证据与历史来源 | Use $soia-pkm-query-vault to answer this question from my vault with cited paths, without changing any files. |
