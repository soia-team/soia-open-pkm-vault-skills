...
OVERRIDE_CONFIG_NAME = "SOIA_PKM_ORGANIZE_ARTICLE_MOC_CONFIG_FILE"
OVERRIDE_ENV_NAME = "SOIA_PKM_ORGANIZE_ENV_FILE"
DEFAULT_CONFIG_FILE = "~/.config/soia-skills/soia-pkm-organize-article-moc/config.yml"
