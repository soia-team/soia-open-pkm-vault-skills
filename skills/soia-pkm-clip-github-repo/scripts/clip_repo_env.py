...
OVERRIDE_CONFIG_NAME = "SOIA_PKM_CLIP_GITHUB_REPO_CONFIG_FILE"
OVERRIDE_ENV_NAME = "SOIA_PKM_CLIP_REPO_ENV_FILE"
DEFAULT_CONFIG_FILE = "~/.config/soia-skills/soia-pkm-clip-github-repo/config.yml"

KEY_RE = re.compile(r"^[A-Za-z_][A-Za-z0-9_]*$")
PATH_LIKE_KEYS = {
    "OBSIDIAN_VAULT",
    "OBSIDIAN_ARTICLES",
    "SOIA_REPO_UPSTREAM_DIR",
}
