...
OVERRIDE_CONFIG_NAME = "SOIA_PKM_MAINTAIN_CONFIG_FILE"
OVERRIDE_ENV_NAME = "SOIA_PKM_MAINTAIN_ENV_FILE"
DEFAULT_CONFIG_FILE = "~/.config/soia-skills/soia-pkm-maintain/config.yml"
