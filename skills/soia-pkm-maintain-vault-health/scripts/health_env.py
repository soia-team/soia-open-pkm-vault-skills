...
OVERRIDE_CONFIG_NAME = "SOIA_PKM_VAULT_HEALTH_CONFIG_FILE"
OVERRIDE_ENV_NAME = "SOIA_PKM_VAULT_HEALTH_ENV_FILE"
DEFAULT_CONFIG_FILE = "~/.config/soia-skills/soia-pkm-maintain-vault-health/config.yml"
