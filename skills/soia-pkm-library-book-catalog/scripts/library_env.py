...
# @version     0.1.0
# @description Resolve portable SOIA PKM library configuration and optional WeRead dependencies.
# @changelog   Unify the library skills on the schema-v2 config namespace.
...
SKILL_ENV_PREFIX = SKILL_NAME.upper().replace("-", "_")
OVERRIDE_CONFIG_NAME = f"{SKILL_ENV_PREFIX}_CONFIG_FILE"
OVERRIDE_ENV_NAME = f"{SKILL_ENV_PREFIX}_ENV_FILE"
LEGACY_OVERRIDE_CONFIG_NAME = "SOIA_PKM_LIBRARY_CONFIG_FILE"
LEGACY_OVERRIDE_ENV_NAME = "SOIA_PKM_LIBRARY_ENV_FILE"
DEFAULT_CONFIG_FILE = str(Path.home() / ".config" / "soia-skills" / SKILL_NAME / "config.yml")
